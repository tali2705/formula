          ...
          <table>
            ...
            <tbody>
              {qualifyingResults.map((qualifyRes) => {
                ...
                const bestTime: string | undefined = getBestTime(qualifyRes);
          ...
          <table>
            ...
            <tbody>
              {raceResult.map((raceRes) => {
                ...
                const color: string = tableColor(raceRes.points, "");
                ...
                return (
                  <tr key={raceRes.position}>
                    ...
                    <td>
                      <Link to={`/teams/${raceRes.Constructor.constructorId}`}>
                        {raceRes.Constructor.name}
                      </Link>
                    </td>
                    <td>{raceRes.Time ? raceRes.Time.time : raceRes.status}</td>
                    <td style={{ backgroundColor: color }}>{raceRes.points}</td>
                  </tr>
                );
              })}
            </tbody>
