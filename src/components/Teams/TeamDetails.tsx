          ...
          <table>
            ...
            <tbody>
              {teamResults.map((result) => {
                const raceResult: ITeamRaceResult[] = result.Results;
                const countryCode: string = flagHandler(
                  result.Circuit.Location.country
                );
                const firstDriverPoints: string = raceResult[0]?.points;
                const secondDriverPoints: string = raceResult[1]?.points;
                ...
                return (
                  <tr key={result.round}>
                    ...
                    <td
                      style={{
                        backgroundColor: colorFirstDriver,
                      }}
                    >
                      {firstDriverPoints || "0"}
                    </td>
                    <td
                      style={{
                        backgroundColor: colorSecondDriver,
                      }}
                    >
