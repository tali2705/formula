...
const DriverDetails = () => {
    ...
    const getDriverDetails = useCallback(async () => {
        const url1 = `http://ergast.com/api/f1/2013/drivers/${driverId}/results.json`;
        const url2 = `http://ergast.com/api/f1/2013/drivers/${driverId}/driverStandings.json`;
        ...
        if (data1 && data2) {
            ...
            const details =
                data2.MRData.StandingsTable.StandingsLists[0]
                    .DriverStandings[0];
